...
class m170116_042825_news extends Migration
{
    public function up()
    {
        ...
        {
            $this->dropForeignKey($foreignKeyName,$category_table_name);
        ...
        $this->createTable($table_name, [
            ...
            $moduleName.'_category_id' => $this->integer()->unsigned(),
            'index' => $this->integer(),
            'image' => $this->string(255),
        ]);

        $this->addForeignKey($foreignKeyName, $table_name, $moduleName.'_category_id',
    ...
    {
        echo "m170116_042825_news cannot be reverted.\n";
